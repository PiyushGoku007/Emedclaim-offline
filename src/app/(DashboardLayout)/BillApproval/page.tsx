...
import DocsPreview from "../components/forms/PreviewPage/DocsPreview";
...
function Approval() {
  ...
  const handleApprove = async () => {
    try {
      const res = await axios.put(
        `${BACKEND_BASE_URL}/api/medical/adminJSApprove`,
        dataPrev,
        {
          headers: {
  ...
  const handleReturn = async () => {
    ...
    try {
      const res = await axios.put(
        `${BACKEND_BASE_URL}/api/medical/returnByadminJS`,
        returnData,
        {
          headers: {
            authorization: `Bearer ${auth?.user?.token}`,
